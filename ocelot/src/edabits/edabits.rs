...
impl<FE: FiniteField> SenderConv<FE> {
    ...
    fn random_edabits<C: AbstractChannel, RNG: CryptoRng + Rng>(
    ...
    ) -> Result<(Vec<Edabits<FE>>, Vec<Edabits<FE>>), Error> {
        ...
        for _ in 0..num {
            ...
            let r_m: FE = convert_f2_to_field(&r);
    ...
    ) -> Result<(Vec<Dabit<FE>>, Vec<Dabit<FE>>), Error> {
