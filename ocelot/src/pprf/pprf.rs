...
use crate::{
    ...
    pprf::{vec_bool_u128, Fp2, PprfReceiver, PprfSender, PPRF as PPRFTrait},
};
...
impl<OT: OtSender<Msg = Block> + Malicious, PPRF: PPRFTrait> PPRFTrait for Sender<OT, PPRF> {
    ...
    fn full_eval(_kstar: Vec<Block>, _alpha: Block) -> Vec<PprfRange> {
...
impl<OT: OtReceiver<Msg = Block> + Malicious, PPRF: PPRFTrait> PPRFTrait for Receiver<OT, PPRF> {
    ...
    fn full_eval(kstar: Vec<Block>, alpha: Block) -> Vec<PprfRange> {
        ...
        /// left shift alpha to make it even i.e. alpha||0
...
mod tests {
    ...
    fn test_ot<
        OTSender: OtSender<Msg = Block> + Malicious,
        OTReceiver: OtReceiver<Msg = Block> + Malicious,
        PPRF: PPRFTrait,
    >() {
