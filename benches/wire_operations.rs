...
fn unpack17(c: &mut Criterion) {
    bench_unpack(c, 17)
}
fn pack17(c: &mut Criterion) {
    bench_pack(c, 17)
}
fn plus17(c: &mut Criterion) {
    bench_plus(c, 17)
}
fn pluseq17(c: &mut Criterion) {
    bench_plus_eq(c, 17)
}
fn cmul17(c: &mut Criterion) {
    bench_cmul(c, 17)
}
fn cmuleq17(c: &mut Criterion) {
    bench_cmul_eq(c, 17)
}
fn negate17(c: &mut Criterion) {
    bench_negate(c, 17)
}
fn hash17(c: &mut Criterion) {
    bench_hash(c, 17)
}
fn zero17(c: &mut Criterion) {
    bench_zero(c, 17)
}
fn rand17(c: &mut Criterion) {
    bench_rand(c, 17)
}
