...
impl crate::SimdBase8 for I8x16 {
    #[doc = "\n # Scalar Equivalent:\n ```\n # use vectoreyes::*;\n # trait SomeTraitForDoc {\n # fn the_doc_function\n #     <\n #             const AMOUNT: usize,\n #     >\n # (\n #         &self  ,\n # )  -> I8x16\n # ;}\n # impl SomeTraitForDoc for I8x16 {\n # fn the_doc_function\n #     <\n #             const AMOUNT: usize,\n #     >\n # (\n #         &self  ,\n # )  -> I8x16\n # {\n let mut out = [0; 16];\n for (out_lane, src_lane) in out\n     .as_chunks_mut::<16>().0.iter_mut()\n     .zip(self.as_array().as_chunks::<16>().0)\n {\n     out_lane[AMOUNT..].copy_from_slice(&src_lane[0..16 - AMOUNT]);\n }\n I8x16::from(out)\n # }\n # }\n ```\n # Avx2\n <ul>\n <li>\n\n [**`_mm_slli_si128`**](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_slli_si128)\n\n\n * `PSLLDQ xmm, imm8`\n </li>\n </ul>"]
    #[inline(always)]
    fn shift_bytes_left<const AMOUNT: usize>(&self) -> I8x16 {
        select_impl_block! { scalar { let mut out = [0; 16]; for (out_lane, src_lane) in out .as_chunks_mut::<16>().0.iter_mut() .zip(self.as_array().as_chunks::<16>().0) { out_lane[AMOUNT..].copy_from_slice(&src_lane[0..16 - AMOUNT]); } I8x16::from(out) } avx2 { Self( avx2::_mm_slli_si128 ::<AMOUNT>(self.0)) } }
    }
    ...
    fn shift_bytes_right<const AMOUNT: usize>(&self) -> I8x16 {
        select_impl_block! { scalar { let mut out = [0; 16]; for (out_lane, src_lane) in out .as_chunks_mut::<16>().0.iter_mut() .zip(self.as_array().as_chunks::<16>().0) { out_lane[0..16 - AMOUNT].copy_from_slice(&src_lane[AMOUNT..]); } I8x16::from(out) } avx2 { Self( avx2::_mm_srli_si128 ::<AMOUNT>(self.0)) } }
    }
...
impl crate::SimdBase8 for I8x32 {
    ...
    fn shift_bytes_left<const AMOUNT: usize>(&self) -> I8x32 {
        select_impl_block! { scalar { let mut out = [0; 32]; for (out_lane, src_lane) in out .as_chunks_mut::<16>().0.iter_mut() .zip(self.as_array().as_chunks::<16>().0) { out_lane[AMOUNT..].copy_from_slice(&src_lane[0..16 - AMOUNT]); } I8x32::from(out) } avx2 { Self( avx2::_mm256_slli_si256 ::<AMOUNT>(self.0)) } }
    }
    ...
    fn shift_bytes_right<const AMOUNT: usize>(&self) -> I8x32 {
        select_impl_block! { scalar { let mut out = [0; 32]; for (out_lane, src_lane) in out .as_chunks_mut::<16>().0.iter_mut() .zip(self.as_array().as_chunks::<16>().0) { out_lane[0..16 - AMOUNT].copy_from_slice(&src_lane[AMOUNT..]); } I8x32::from(out) } avx2 { Self( avx2::_mm256_srli_si256 ::<AMOUNT>(self.0)) } }
    }
...
impl crate::SimdBase8 for U8x16 {
    ...
    fn shift_bytes_left<const AMOUNT: usize>(&self) -> U8x16 {
        select_impl_block! { scalar { let mut out = [0; 16]; for (out_lane, src_lane) in out .as_chunks_mut::<16>().0.iter_mut() .zip(self.as_array().as_chunks::<16>().0) { out_lane[AMOUNT..].copy_from_slice(&src_lane[0..16 - AMOUNT]); } U8x16::from(out) } avx2 { Self( avx2::_mm_slli_si128 ::<AMOUNT>(self.0)) } }
    }
    #[doc = "\n # Scalar Equivalent:\n ```\n # use vectoreyes::*;\n # trait SomeTraitForDoc {\n # fn the_doc_function\n #     <\n #             const AMOUNT: usize,\n #     >\n # (\n #         &self  ,\n # )  -> U8x16\n # ;}\n # impl SomeTraitForDoc for U8x16 {\n # fn the_doc_function\n #     <\n #             const AMOUNT: usize,\n #     >\n # (\n #         &self  ,\n # )  -> U8x16\n # {\n let mut out = [0; 16];\n for (out_lane, src_lane) in out\n     .as_chunks_mut::<16>().0.iter_mut()\n     .zip(self.as_array().as_chunks::<16>().0)\n {\n     out_lane[0..16 - AMOUNT].copy_from_slice(&src_lane[AMOUNT..]);\n }\n U8x16::from(out)\n # }\n # }\n ```\n # Avx2\n <ul>\n <li>\n\n [**`_mm_srli_si128`**](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_srli_si128)\n\n\n * `PSRLDQ xmm, imm8`\n </li>\n </ul>"]
    #[inline(always)]
    fn shift_bytes_right<const AMOUNT: usize>(&self) -> U8x16 {
        select_impl_block! { scalar { let mut out = [0; 16]; for (out_lane, src_lane) in out .as_chunks_mut::<16>().0.iter_mut() .zip(self.as_array().as_chunks::<16>().0) { out_lane[0..16 - AMOUNT].copy_from_slice(&src_lane[AMOUNT..]); } U8x16::from(out) } avx2 { Self( avx2::_mm_srli_si128 ::<AMOUNT>(self.0)) } }
    }
    #[doc = "\n # Scalar Equivalent:\n ```\n # use vectoreyes::*;\n # trait SomeTraitForDoc {\n # fn the_doc_function\n # (\n #         &self  ,\n # )  -> u32\n # ;}\n # impl SomeTraitForDoc for U8x16 {\n # fn the_doc_function\n # (\n #         &self  ,\n # )  -> u32\n # {\n let mut out: u32 = 0;\n for (i, value) in self.as_array().iter().copied().enumerate() {\n     out |= u32::from((value as u8) >> 7) << i;\n }\n out\n # }\n # }\n ```\n # Avx2\n <ul>\n <li>\n\n [**`_mm_movemask_epi8`**](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_movemask_epi8)\n\n\n * `PMOVMSKB r32, xmm`\n </li>\n </ul>"]
    #[inline(always)]
    fn most_significant_bits(&self) -> u32 {
...
impl crate::SimdBase8 for U8x32 {
    ...
    fn shift_bytes_left<const AMOUNT: usize>(&self) -> U8x32 {
        select_impl_block! { scalar { let mut out = [0; 32]; for (out_lane, src_lane) in out .as_chunks_mut::<16>().0.iter_mut() .zip(self.as_array().as_chunks::<16>().0) { out_lane[AMOUNT..].copy_from_slice(&src_lane[0..16 - AMOUNT]); } U8x32::from(out) } avx2 { Self( avx2::_mm256_slli_si256 ::<AMOUNT>(self.0)) } }
    }
    #[doc = "\n # Scalar Equivalent:\n ```\n # use vectoreyes::*;\n # trait SomeTraitForDoc {\n # fn the_doc_function\n #     <\n #             const AMOUNT: usize,\n #     >\n # (\n #         &self  ,\n # )  -> U8x32\n # ;}\n # impl SomeTraitForDoc for U8x32 {\n # fn the_doc_function\n #     <\n #             const AMOUNT: usize,\n #     >\n # (\n #         &self  ,\n # )  -> U8x32\n # {\n let mut out = [0; 32];\n for (out_lane, src_lane) in out\n     .as_chunks_mut::<16>().0.iter_mut()\n     .zip(self.as_array().as_chunks::<16>().0)\n {\n     out_lane[0..16 - AMOUNT].copy_from_slice(&src_lane[AMOUNT..]);\n }\n U8x32::from(out)\n # }\n # }\n ```\n # Avx2\n <ul>\n <li>\n\n [**`_mm256_srli_si256`**](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_srli_si256)\n\n\n * `VPSRLDQ ymm, ymm, imm8`\n </li>\n </ul>"]
    #[inline(always)]
    fn shift_bytes_right<const AMOUNT: usize>(&self) -> U8x32 {
        select_impl_block! { scalar { let mut out = [0; 32]; for (out_lane, src_lane) in out .as_chunks_mut::<16>().0.iter_mut() .zip(self.as_array().as_chunks::<16>().0) { out_lane[0..16 - AMOUNT].copy_from_slice(&src_lane[AMOUNT..]); } U8x32::from(out) } avx2 { Self( avx2::_mm256_srli_si256 ::<AMOUNT>(self.0)) } }
    }
    #[doc = "\n # Scalar Equivalent:\n ```\n # use vectoreyes::*;\n # trait SomeTraitForDoc {\n # fn the_doc_function\n # (\n #         &self  ,\n # )  -> u32\n # ;}\n # impl SomeTraitForDoc for U8x32 {\n # fn the_doc_function\n # (\n #         &self  ,\n # )  -> u32\n # {\n let mut out: u32 = 0;\n for (i, value) in self.as_array().iter().copied().enumerate() {\n     out |= u32::from((value as u8) >> 7) << i;\n }\n out\n # }\n # }\n ```\n # Avx2\n <ul>\n <li>\n\n [**`_mm256_movemask_epi8`**](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_movemask_epi8)\n\n\n * `VPMOVMSKB r32, ymm`\n </li>\n </ul>"]
    #[inline(always)]
    fn most_significant_bits(&self) -> u32 {
