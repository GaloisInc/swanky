// CACHE KEY c33cb3fb497c04304716769b302dd724658d63ad016a045222447d1fdd7a65e9
...
impl<'a> ::flatbuffers::Follow<'a> for &'a Count {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { ::flatbuffers::follow_cast_ref::<Count>(buf, loc) }
  }
}
impl<'b> ::flatbuffers::Push for Count {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = unsafe { ::core::slice::from_raw_parts(self as *const Count as *const u8, <Self as ::flatbuffers::Push>::size()) };
...
impl<'a> ::flatbuffers::Follow<'a> for Conversion {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { <&'a Conversion>::follow(buf, loc) }
  }
}
impl<'a> ::flatbuffers::Follow<'a> for &'a Conversion {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { ::flatbuffers::follow_cast_ref::<Conversion>(buf, loc) }
  }
}
impl<'b> ::flatbuffers::Push for Conversion {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = unsafe { ::core::slice::from_raw_parts(self as *const Conversion as *const u8, <Self as ::flatbuffers::Push>::size()) };
        dst.copy_from_slice(src);
    }
    #[inline]
    fn alignment() -> ::flatbuffers::PushAlignment {
...
impl<'a> ::flatbuffers::Follow<'a> for WireRange {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { <&'a WireRange>::follow(buf, loc) }
  }
}
impl<'a> ::flatbuffers::Follow<'a> for &'a WireRange {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { ::flatbuffers::follow_cast_ref::<WireRange>(buf, loc) }
  }
}
impl<'b> ::flatbuffers::Push for WireRange {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = unsafe { ::core::slice::from_raw_parts(self as *const WireRange as *const u8, <Self as ::flatbuffers::Push>::size()) };
        dst.copy_from_slice(src);
    }
    #[inline]
    fn alignment() -> ::flatbuffers::PushAlignment {
...
pub fn root_as_root(buf: &[u8]) -> Result<Root<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_root(buf: &[u8]) -> Result<Root<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_root_unchecked(buf: &[u8]) -> Root<'_> {
  unsafe { ::flatbuffers::root_unchecked::<Root>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_root_unchecked(buf: &[u8]) -> Root<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<Root>(buf) }
}
