...
pub mod sieve_ir {
    ...
    impl DirectiveSet {
        ...
        pub const ENUM_VALUES: &'static [Self] = &[Self::NONE, Self::Gate, Self::Function];
        /// Returns the variant's name or "" if unknown.
        pub fn variant_name(self) -> Option<&'static str> {
            match self {
                Self::NONE => Some("NONE"),
    ...
    #[allow(non_camel_case_types)]
    pub const ENUM_VALUES_TYPE_U: [TypeU; 3] = [TypeU::NONE, TypeU::Field, TypeU::PluginType];
    ...
    impl TypeU {
        ...
        pub const ENUM_MIN: u8 = 0;
        pub const ENUM_MAX: u8 = 2;
        pub const ENUM_VALUES: &'static [Self] = &[Self::NONE, Self::Field, Self::PluginType];
        /// Returns the variant's name or "" if unknown.
        pub fn variant_name(self) -> Option<&'static str> {
            match self {
                Self::NONE => Some("NONE"),
    ...
    impl FunctionBody {
        ...
        pub const ENUM_MIN: u8 = 0;
        pub const ENUM_MAX: u8 = 2;
        pub const ENUM_VALUES: &'static [Self] = &[Self::NONE, Self::Gates, Self::PluginBody];
        /// Returns the variant's name or "" if unknown.
        pub fn variant_name(self) -> Option<&'static str> {
            match self {
                Self::NONE => Some("NONE"),
    ...
    impl<'b> flatbuffers::Push for Count {
        ...
        unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
            let src =
                ::core::slice::from_raw_parts(self as *const Count as *const u8, Self::size());
    ...
    impl<'a> Count {
        ...
        pub fn new(type_id: u8, count: u64) -> Self {
            let mut s = Self([0; 16]);
    ...
    impl<'b> flatbuffers::Push for Conversion {
        ...
        unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
            let src =
                ::core::slice::from_raw_parts(self as *const Conversion as *const u8, Self::size());
            dst.copy_from_slice(src);
        }
    }
    ...
    impl<'b> flatbuffers::Push for WireRange {
        ...
        unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
            let src =
                ::core::slice::from_raw_parts(self as *const WireRange as *const u8, Self::size());
            dst.copy_from_slice(src);
        }
    }
    ...
    impl<'a> WireRange {
        #[allow(clippy::too_many_arguments)]
        pub fn new(first_id: u64, last_id: u64) -> Self {
            let mut s = Self([0; 16]);
    ...
    impl<'a> Relation<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.conversions {
                builder.add_conversions(x);
            }
        ...
        pub fn version(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(Relation::VT_VERSION, None)
            }
        }
        #[inline]
        pub fn plugins(
        ...
        pub fn types(
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Type>>,
                >>(Relation::VT_TYPES, None)
            }
        }
        #[inline]
        pub fn conversions(&self) -> Option<flatbuffers::Vector<'a, Conversion>> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, Conversion>>>(
                        Relation::VT_CONVERSIONS,
                        None,
                    )
            }
        }
        ...
        pub fn directives(
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Directive>>,
    ...
    impl flatbuffers::Verifiable for Relation<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                >>("plugins", Self::VT_PLUGINS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Type>>,
                >>("types", Self::VT_TYPES, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, Conversion>>>(
                    "conversions",
                    Self::VT_CONVERSIONS,
                    false,
                )?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Directive>>,
    ...
    impl<'a: 'b, 'b> RelationBuilder<'a, 'b> {
        ...
        pub fn add_version(&mut self, version: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Relation::VT_VERSION, version);
        }
        #[inline]
        pub fn add_plugins(
            &mut self,
        ...
        pub fn add_types(
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Relation::VT_TYPES, types);
        }
        #[inline]
        pub fn add_conversions(
            &mut self,
            conversions: flatbuffers::WIPOffset<flatbuffers::Vector<'b, Conversion>>,
        ) {
    ...
    impl<'a> PublicInputs<'a> {
        ...
        pub fn version(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(PublicInputs::VT_VERSION, None)
            }
        }
        #[inline]
        pub fn type_(&self) -> Option<Type<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<Type>>(PublicInputs::VT_TYPE_, None)
            }
        }
        #[inline]
        pub fn inputs(
    ...
    impl<'a: 'b, 'b> PublicInputsBuilder<'a, 'b> {
        ...
        pub fn add_version(&mut self, version: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(PublicInputs::VT_VERSION, version);
        }
        #[inline]
        pub fn add_type_(&mut self, type_: flatbuffers::WIPOffset<Type<'b>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<Type>>(PublicInputs::VT_TYPE_, type_);
        }
        #[inline]
        pub fn add_inputs(
            &mut self,
    ...
    impl<'a> PrivateInputs<'a> {
        ...
        pub fn version(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(PrivateInputs::VT_VERSION, None)
            }
        }
        #[inline]
        pub fn type_(&self) -> Option<Type<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<Type>>(PrivateInputs::VT_TYPE_, None)
            }
        }
        #[inline]
        pub fn inputs(
    ...
    impl<'a: 'b, 'b> PrivateInputsBuilder<'a, 'b> {
        ...
        pub fn add_version(&mut self, version: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(PrivateInputs::VT_VERSION, version);
        }
        #[inline]
        pub fn add_type_(&mut self, type_: flatbuffers::WIPOffset<Type<'b>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<Type>>(PrivateInputs::VT_TYPE_, type_);
        }
        #[inline]
        pub fn add_inputs(
            &mut self,
    ...
    impl flatbuffers::Verifiable for Directive<'_> {
        ...
        fn run_verifier(
            ...
            use self::flatbuffers::Verifiable;
            v.visit_table(pos)?
                .visit_union::<DirectiveSet, _>(
                    "directive_type",
                    Self::VT_DIRECTIVE_TYPE,
                    "directive",
                    Self::VT_DIRECTIVE,
                    false,
                    |key, v, pos| match key {
                        DirectiveSet::Gate => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<Gate>>(
                                "DirectiveSet::Gate",
                                pos,
                            ),
                        DirectiveSet::Function => v
    ...
    impl<'a> Type<'a> {
        ...
        pub fn element_type(&self) -> TypeU {
            ...
            unsafe {
                self._tab
                    .get::<TypeU>(Type::VT_ELEMENT_TYPE, Some(TypeU::NONE))
                    .unwrap()
            }
        }
        #[inline]
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_union::<TypeU, _>(
                    ...
                    |key, v, pos| match key {
                        TypeU::Field => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<Field>>(
                                "TypeU::Field",
                                pos,
                            ),
                        TypeU::PluginType => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<PluginType>>(
                                "TypeU::PluginType",
                                pos,
                            ),
                        _ => Ok(()),
    ...
    impl<'a: 'b, 'b> TypeBuilder<'a, 'b> {
        ...
        pub fn add_element_type(&mut self, element_type: TypeU) {
            self.fbb_
                .push_slot::<TypeU>(Type::VT_ELEMENT_TYPE, element_type, TypeU::NONE);
        }
        #[inline]
        pub fn add_element(
            &mut self,
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Type::VT_ELEMENT, element);
        }
        #[inline]
    ...
    impl<'a> Field<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.modulo {
                builder.add_modulo(x);
            }
            builder.finish()
        }
        ...
        pub fn modulo(&self) -> Option<Value<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<Value>>(Field::VT_MODULO, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b> FieldBuilder<'a, 'b> {
        ...
        pub fn add_modulo(&mut self, modulo: flatbuffers::WIPOffset<Value<'b>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<Value>>(Field::VT_MODULO, modulo);
        }
        #[inline]
    ...
    impl<'a> PluginType<'a> {
        ...
        pub fn name(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(PluginType::VT_NAME, None)
            }
        }
        #[inline]
        pub fn operation(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(PluginType::VT_OPERATION, None)
            }
        }
        #[inline]
        pub fn params(
    ...
    impl<'a: 'b, 'b> PluginTypeBuilder<'a, 'b> {
        ...
        pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(PluginType::VT_NAME, name);
        }
        #[inline]
        pub fn add_operation(&mut self, operation: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(PluginType::VT_OPERATION, operation);
        }
        #[inline]
        pub fn add_params(
            &mut self,
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(PluginType::VT_PARAMS, params);
        }
        #[inline]
    ...
    impl<'a> GateConstant<'a> {
        ...
        pub fn type_id(&self) -> u8 {
            ...
            unsafe {
                self._tab
                    .get::<u8>(GateConstant::VT_TYPE_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn out_id(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(GateConstant::VT_OUT_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
    ...
    impl<'a: 'b, 'b> GateConstantBuilder<'a, 'b> {
        ...
        pub fn add_type_id(&mut self, type_id: u8) {
            self.fbb_
                .push_slot::<u8>(GateConstant::VT_TYPE_ID, type_id, 0);
        }
        #[inline]
        pub fn add_out_id(&mut self, out_id: u64) {
            self.fbb_
                .push_slot::<u64>(GateConstant::VT_OUT_ID, out_id, 0);
        }
        #[inline]
        pub fn add_constant(
            &mut self,
    ...
    impl<'a> GateAssertZero<'a> {
        ...
        pub fn type_id(&self) -> u8 {
            ...
            unsafe {
                self._tab
                    .get::<u8>(GateAssertZero::VT_TYPE_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn in_id(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(GateAssertZero::VT_IN_ID, Some(0))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b> GateAssertZeroBuilder<'a, 'b> {
        ...
        pub fn add_type_id(&mut self, type_id: u8) {
            self.fbb_
                .push_slot::<u8>(GateAssertZero::VT_TYPE_ID, type_id, 0);
        }
        #[inline]
        pub fn add_in_id(&mut self, in_id: u64) {
            self.fbb_
                .push_slot::<u64>(GateAssertZero::VT_IN_ID, in_id, 0);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    ...
    impl<'a: 'b, 'b> GateAddBuilder<'a, 'b> {
        ...
        pub fn add_right_id(&mut self, right_id: u64) {
            self.fbb_
                .push_slot::<u64>(GateAdd::VT_RIGHT_ID, right_id, 0);
        }
        #[inline]
    ...
    impl<'a: 'b, 'b> GateMulBuilder<'a, 'b> {
        ...
        pub fn add_right_id(&mut self, right_id: u64) {
            self.fbb_
                .push_slot::<u64>(GateMul::VT_RIGHT_ID, right_id, 0);
        }
        #[inline]
    ...
    impl<'a> GateAddConstant<'a> {
        ...
        pub fn type_id(&self) -> u8 {
            ...
            unsafe {
                self._tab
                    .get::<u8>(GateAddConstant::VT_TYPE_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn out_id(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(GateAddConstant::VT_OUT_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn in_id(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(GateAddConstant::VT_IN_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
    ...
    impl<'a: 'b, 'b> GateAddConstantBuilder<'a, 'b> {
        ...
        pub fn add_type_id(&mut self, type_id: u8) {
            self.fbb_
                .push_slot::<u8>(GateAddConstant::VT_TYPE_ID, type_id, 0);
        }
        #[inline]
        pub fn add_out_id(&mut self, out_id: u64) {
            self.fbb_
                .push_slot::<u64>(GateAddConstant::VT_OUT_ID, out_id, 0);
        }
        #[inline]
        pub fn add_in_id(&mut self, in_id: u64) {
            self.fbb_
                .push_slot::<u64>(GateAddConstant::VT_IN_ID, in_id, 0);
        }
        #[inline]
        pub fn add_constant(
            &mut self,
    ...
    impl<'a> GateMulConstant<'a> {
        ...
        pub fn type_id(&self) -> u8 {
            ...
            unsafe {
                self._tab
                    .get::<u8>(GateMulConstant::VT_TYPE_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn out_id(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(GateMulConstant::VT_OUT_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn in_id(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(GateMulConstant::VT_IN_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
    ...
    impl<'a: 'b, 'b> GateMulConstantBuilder<'a, 'b> {
        ...
        pub fn add_type_id(&mut self, type_id: u8) {
            self.fbb_
                .push_slot::<u8>(GateMulConstant::VT_TYPE_ID, type_id, 0);
        }
        #[inline]
        pub fn add_out_id(&mut self, out_id: u64) {
            self.fbb_
                .push_slot::<u64>(GateMulConstant::VT_OUT_ID, out_id, 0);
        }
        #[inline]
        pub fn add_in_id(&mut self, in_id: u64) {
            self.fbb_
                .push_slot::<u64>(GateMulConstant::VT_IN_ID, in_id, 0);
        }
        #[inline]
        pub fn add_constant(
            &mut self,
    ...
    impl<'a> GatePublic<'a> {
        ...
        pub fn type_id(&self) -> u8 {
            ...
            unsafe {
                self._tab
                    .get::<u8>(GatePublic::VT_TYPE_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn out_id(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(GatePublic::VT_OUT_ID, Some(0))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b> GatePublicBuilder<'a, 'b> {
        ...
        pub fn add_type_id(&mut self, type_id: u8) {
            self.fbb_
                .push_slot::<u8>(GatePublic::VT_TYPE_ID, type_id, 0);
        }
        #[inline]
        pub fn add_out_id(&mut self, out_id: u64) {
    ...
    impl<'a> GatePrivate<'a> {
        ...
        pub fn type_id(&self) -> u8 {
            ...
            unsafe {
                self._tab
                    .get::<u8>(GatePrivate::VT_TYPE_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn out_id(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(GatePrivate::VT_OUT_ID, Some(0))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b> GatePrivateBuilder<'a, 'b> {
        ...
        pub fn add_type_id(&mut self, type_id: u8) {
            self.fbb_
                .push_slot::<u8>(GatePrivate::VT_TYPE_ID, type_id, 0);
        }
        #[inline]
        pub fn add_out_id(&mut self, out_id: u64) {
            self.fbb_
                .push_slot::<u64>(GatePrivate::VT_OUT_ID, out_id, 0);
        }
        #[inline]
    ...
    impl<'a: 'b, 'b> GateNewBuilder<'a, 'b> {
        ...
        pub fn add_first_id(&mut self, first_id: u64) {
            self.fbb_
                .push_slot::<u64>(GateNew::VT_FIRST_ID, first_id, 0);
        }
        #[inline]
    ...
    impl<'a> GateDelete<'a> {
        ...
        pub fn type_id(&self) -> u8 {
            ...
            unsafe {
                self._tab
                    .get::<u8>(GateDelete::VT_TYPE_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn first_id(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(GateDelete::VT_FIRST_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn last_id(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(GateDelete::VT_LAST_ID, Some(0))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b> GateDeleteBuilder<'a, 'b> {
        ...
        pub fn add_type_id(&mut self, type_id: u8) {
            self.fbb_
                .push_slot::<u8>(GateDelete::VT_TYPE_ID, type_id, 0);
        }
        #[inline]
        pub fn add_first_id(&mut self, first_id: u64) {
            self.fbb_
                .push_slot::<u64>(GateDelete::VT_FIRST_ID, first_id, 0);
        }
        #[inline]
        pub fn add_last_id(&mut self, last_id: u64) {
            self.fbb_
                .push_slot::<u64>(GateDelete::VT_LAST_ID, last_id, 0);
        }
        #[inline]
    ...
    impl<'a> GateConvert<'a> {
        ...
        pub fn out_type_id(&self) -> u8 {
            ...
            unsafe {
                self._tab
                    .get::<u8>(GateConvert::VT_OUT_TYPE_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn out_first_id(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(GateConvert::VT_OUT_FIRST_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn out_last_id(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(GateConvert::VT_OUT_LAST_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn in_type_id(&self) -> u8 {
            ...
            unsafe {
                self._tab
                    .get::<u8>(GateConvert::VT_IN_TYPE_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn in_first_id(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(GateConvert::VT_IN_FIRST_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn in_last_id(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(GateConvert::VT_IN_LAST_ID, Some(0))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b> GateConvertBuilder<'a, 'b> {
        ...
        pub fn add_out_type_id(&mut self, out_type_id: u8) {
            self.fbb_
                .push_slot::<u8>(GateConvert::VT_OUT_TYPE_ID, out_type_id, 0);
        }
        #[inline]
        pub fn add_out_first_id(&mut self, out_first_id: u64) {
            self.fbb_
                .push_slot::<u64>(GateConvert::VT_OUT_FIRST_ID, out_first_id, 0);
        }
        #[inline]
        pub fn add_out_last_id(&mut self, out_last_id: u64) {
            self.fbb_
                .push_slot::<u64>(GateConvert::VT_OUT_LAST_ID, out_last_id, 0);
        }
        #[inline]
        pub fn add_in_type_id(&mut self, in_type_id: u8) {
            self.fbb_
                .push_slot::<u8>(GateConvert::VT_IN_TYPE_ID, in_type_id, 0);
        }
        #[inline]
        pub fn add_in_first_id(&mut self, in_first_id: u64) {
            self.fbb_
                .push_slot::<u64>(GateConvert::VT_IN_FIRST_ID, in_first_id, 0);
        }
        #[inline]
        pub fn add_in_last_id(&mut self, in_last_id: u64) {
            self.fbb_
                .push_slot::<u64>(GateConvert::VT_IN_LAST_ID, in_last_id, 0);
        }
        #[inline]
    ...
    impl<'a> Gates<'a> {
        ...
        pub fn gates(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Gate<'a>>>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Gate>>,
                >>(Gates::VT_GATES, None)
            }
        }
    }
    ...
    impl flatbuffers::Verifiable for Gates<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Gate>>,
                >>("gates", Self::VT_GATES, false)?
                .finish();
            Ok(())
        }
    }
    pub struct GatesArgs<'a> {
        pub gates: Option<
            flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Gate<'a>>>>,
        >,
    }
    ...
    impl<'a: 'b, 'b> GatesBuilder<'a, 'b> {
        ...
        pub fn add_gates(
            ...
            gates: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<Gate<'b>>>,
            >,
        ) {
            self.fbb_
    ...
    impl<'a> PluginBody<'a> {
        ...
        pub fn public_count(&self) -> Option<flatbuffers::Vector<'a, Count>> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, Count>>>(
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<&'_ str>>,
                >>("params", Self::VT_PARAMS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, Count>>>(
                    "public_count",
                    Self::VT_PUBLIC_COUNT,
                    false,
                )?
                .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, Count>>>(
                    "private_count",
                    Self::VT_PRIVATE_COUNT,
                    false,
                )?
                .finish();
            Ok(())
    ...
    impl<'a: 'b, 'b> PluginBodyBuilder<'a, 'b> {
        ...
        pub fn add_public_count(
            &mut self,
            public_count: flatbuffers::WIPOffset<flatbuffers::Vector<'b, Count>>,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                PluginBody::VT_PUBLIC_COUNT,
                public_count,
        ...
        pub fn add_private_count(
            &mut self,
            private_count: flatbuffers::WIPOffset<flatbuffers::Vector<'b, Count>>,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                PluginBody::VT_PRIVATE_COUNT,
                private_count,
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_union::<FunctionBody, _>(
                    ...
                    false,
                    |key, v, pos| match key {
                        FunctionBody::Gates => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<Gates>>(
                                "FunctionBody::Gates",
                                pos,
                            ),
                        FunctionBody::PluginBody => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<PluginBody>>(
                                "FunctionBody::PluginBody",
                                pos,
                            ),
                        _ => Ok(()),
    ...
    impl<'a: 'b, 'b> FunctionBuilder<'a, 'b> {
        ...
        pub fn add_output_count(
            &mut self,
            output_count: flatbuffers::WIPOffset<flatbuffers::Vector<'b, Count>>,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                Function::VT_OUTPUT_COUNT,
                output_count,
        ...
        pub fn add_input_count(
            &mut self,
            input_count: flatbuffers::WIPOffset<flatbuffers::Vector<'b, Count>>,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                Function::VT_INPUT_COUNT,
                input_count,
    ...
    impl<'a> GateCall<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.in_ids {
                builder.add_in_ids(x);
            }
            if let Some(x) = args.out_ids {
                builder.add_out_ids(x);
            }
            if let Some(x) = args.name {
                builder.add_name(x);
            }
        ...
        pub fn out_ids(&self) -> Option<flatbuffers::Vector<'a, WireRange>> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, WireRange>>>(
                        GateCall::VT_OUT_IDS,
                        None,
                    )
            }
    ...
    impl flatbuffers::Verifiable for GateCall<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<flatbuffers::ForwardsUOffset<&str>>("name", Self::VT_NAME, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, WireRange>>>(
                    "out_ids",
                    Self::VT_OUT_IDS,
                    false,
                )?
    ...
    impl<'a: 'b, 'b> GateCallBuilder<'a, 'b> {
        ...
        pub fn add_out_ids(
            &mut self,
            out_ids: flatbuffers::WIPOffset<flatbuffers::Vector<'b, WireRange>>,
        ) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(GateCall::VT_OUT_IDS, out_ids);
        }
        #[inline]
        pub fn add_in_ids(
            &mut self,
            in_ids: flatbuffers::WIPOffset<flatbuffers::Vector<'b, WireRange>>,
        ) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(GateCall::VT_IN_IDS, in_ids);
        }
        #[inline]
    ...
    impl<'a> Gate<'a> {
        ...
        pub fn gate_type(&self) -> GateSet {
            ...
            unsafe {
                self._tab
                    .get::<GateSet>(Gate::VT_GATE_TYPE, Some(GateSet::NONE))
                    .unwrap()
            }
        }
        #[inline]
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_union::<GateSet, _>(
                    ...
                    false,
                    |key, v, pos| match key {
                        GateSet::GateConstant => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<GateConstant>>(
                                "GateSet::GateConstant",
                                pos,
                            ),
                        GateSet::GateAssertZero => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<GateAssertZero>>(
                                "GateSet::GateAssertZero",
                                pos,
                            ),
                        GateSet::GateCopy => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<GateCopy>>(
                                "GateSet::GateCopy",
                                pos,
                            ),
                        GateSet::GateAdd => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<GateAdd>>(
                                "GateSet::GateAdd",
                                pos,
                            ),
                        GateSet::GateMul => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<GateMul>>(
                                "GateSet::GateMul",
                                pos,
                            ),
                        GateSet::GateAddConstant => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<GateAddConstant>>(
                                "GateSet::GateAddConstant",
                                pos,
                            ),
                        GateSet::GateMulConstant => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<GateMulConstant>>(
                                "GateSet::GateMulConstant",
                                pos,
                            ),
                        GateSet::GatePublic => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<GatePublic>>(
                                "GateSet::GatePublic",
                                pos,
                            ),
                        GateSet::GatePrivate => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<GatePrivate>>(
                                "GateSet::GatePrivate",
                                pos,
                            ),
                        GateSet::GateNew => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<GateNew>>(
                                "GateSet::GateNew",
                                pos,
                            ),
                        GateSet::GateDelete => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<GateDelete>>(
                                "GateSet::GateDelete",
                                pos,
                            ),
                        GateSet::GateConvert => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<GateConvert>>(
                                "GateSet::GateConvert",
                                pos,
                            ),
                        GateSet::GateCall => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<GateCall>>(
                                "GateSet::GateCall",
                                pos,
                            ),
                        _ => Ok(()),
    ...
    impl<'a: 'b, 'b> GateBuilder<'a, 'b> {
        ...
        pub fn add_gate_type(&mut self, gate_type: GateSet) {
            self.fbb_
                .push_slot::<GateSet>(Gate::VT_GATE_TYPE, gate_type, GateSet::NONE);
        }
        #[inline]
        pub fn add_gate(&mut self, gate: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Gate::VT_GATE, gate);
        }
        #[inline]
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_union::<Message, _>(
                    ...
                    |key, v, pos| match key {
                        Message::Relation => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<Relation>>(
                                "Message::Relation",
                                pos,
                            ),
                        Message::PublicInputs => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<PublicInputs>>(
                                "Message::PublicInputs",
                                pos,
                            ),
                        Message::PrivateInputs => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<PrivateInputs>>(
                                "Message::PrivateInputs",
                                pos,
                            ),
                        _ => Ok(()),
